...
namespace ims.Infrastructure.SeedData
{
    ...
    {
        public static object Permissions { get; private set; }
        ...
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            await SeedRolePermissionsAsync(roleManager, "SuperAdmin", Permissions.AllPermissions);
            await SeedRolePermissionsAsync(roleManager, "Admin", Permissions.AllPermissions.Where(p =>
                p.Contains(".View") || p.Contains(".Create") || p.Contains(".Update") || p.Contains(".Delete")).ToArray());

            await SeedRolePermissionsAsync(roleManager, "Manager", Permissions.AllPermissions.Where(p =>
                p.Contains(".View") || p.Contains(".Create") || p.Contains(".Update")).ToArray());

            await SeedRolePermissionsAsync(roleManager, "Staff", Permissions.AllPermissions.Where(p =>
                p.Contains(".View")).ToArray());
